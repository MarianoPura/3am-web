...
return [
    ...
    'slots' => [
        ...
        'channel.technology' => [
            'ratio' => '4x3',
            'label' => 'Technology',
            'src' => 'media/technology-operations.jpg',
            'alt' => 'Presenters demonstrating a laptop and projected interface to seated attendees, with a projector on the table',
        ],
        'channel.ventures' => [
            'ratio' => '4x3',
            'label' => 'Ventures',
